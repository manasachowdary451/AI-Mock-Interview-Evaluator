    ...
    <div className="container mx-auto px-4 py-12">
      <div className="text-center mb-12">
        <h1 className="text-4xl font-bold text-gray-800 mb-4">
          ...
          Skill Up AI: Your Interview Preparation Companion
        </h1>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 relative">
        {steps.map((step, index) => (
          <div 
            key={step.title} 
            className="bg-white/70 backdrop-blur-md p-6 rounded-xl shadow-lg border border-gray-200 
           transition-all duration-300 hover:scale-105 hover:shadow-2xl"
          >
            <div className="flex items-center mb-4">
              {step.icon}
              <h2 className="ml-4 text-2xl font-semibold bg-gradient-to-r from-indigo-400 to-purple-500 
