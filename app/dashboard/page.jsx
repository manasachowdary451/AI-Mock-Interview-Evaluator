...
function Dashboard() {
  ...
  const calculateImprovementRate = (interviews) => {
    ...
    const improvement = ((scores[scores.length - 1] - scores[0]) / scores[0]) * 10;
  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-7xl">
      ...
      <div className="bg-gray-50 p-4 sm:p-6 rounded-lg">
        ...
        <div className="flex items-center justify-center border border-indigo-600 text-indigo-600 px-6 py-3 rounded-lg hover:bg-indigo-50 transition-colors">
          <AddNewInterview 
