...
const ResourceCard = ({ icon, title, description, links }) => (
  <div className="bg-gradient-to-r from-orange-100 via-pink-100 to-purple-200 rounded-xl shadow-md hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 p-6 flex flex-col h-full">
...
export default function ResourcesPage() {
  ...
  return (
    <>
    <HeroSection />
    <div className="relative animated-box bg-gradient-to-br from-gray-100 to-white min-h-[40vh] py-10 rounded-2xl shadow-xl overflow-hidden mb-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-16 bg-gradient-to-r from-orange-100 via-pink-100 to-purple-200 rounded-xl shadow-lg overflow-hidden">
