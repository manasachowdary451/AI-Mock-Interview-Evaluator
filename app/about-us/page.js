...
const AboutUsPage = () => {
  ...
  const tabContent = {
    mission: {
      ...
      content: (
        <div className="space-y-4">
          <p className="text-base md:text-lg">Skill-Up AI is on a mission to revolutionize interview preparation by providing personalized, intelligent AI coaching tailored to individual career aspirations.</p>
          <p className="text-base md:text-lg">With Skill-Up AI, the goal is to bridge the gap between preparation and success, empowering users to unlock their full potential.</p>
        </div>
      )
    },
    story: {
      ...
      content: (
        <div className="space-y-4">
          <p className="text-base md:text-lg">The idea for Skill-Up AI was born from firsthand experiences with the challenges of interview preparation. As a solo developer, I wanted to create a platform that simplifies the process and builds confidence in individuals.</p>
    ...
    approach: {
      ...
      content: (
        <div className="space-y-4">
          <p className="text-base md:text-lg">Skill-Up AI leverages advanced AI algorithms to generate dynamic, contextually relevant interview questions based on your professional background and goals.</p>
  ...
  return (
    <div className="min-h-screen bg-gray-150 py-8 sm:py-12 md:py-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        {/* Hero Section */}
        <div className="text-center mb-8 sm:mb-12 md:mb-16 bg-gray-100 py-10 rounded-xl shadow-md border border-gray-200">
        ...
        <div className="bg-white shadow-lg rounded-lg overflow-hidden mb-8 sm:mb-12 md:mb-16">
            ...
            {Object.keys(tabContent).map((tab) => (
              <button
                ...
                className={`w-full sm:flex-1 py-3 sm:py-4 px-4 sm:px-6 flex items-center justify-center 
                  ${activeTab === tab 
                    ? 'text-indigo-700 bg-indigo-100 font-semibold border-b-2 border-indigo-600 shadow-inner'  
          ...
          <div className="p-4 sm:p-6 md:p-8 transition-all duration-300 ease-out animate-fadeIn">
